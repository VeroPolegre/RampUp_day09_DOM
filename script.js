...
document
  ...
  .addEventListener("click", mostrarOcultarParrafo);
...
document
  .getElementById("gato_lloron")
  .addEventListener("mouseover", mostrarOcultarTituloFoto);
document
  .getElementById("gato_lloron")
  .addEventListener("mouseout", mostrarOcultarTituloFoto);
